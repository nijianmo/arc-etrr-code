...
parser.add_argument('--embedding_file', type=str, default='/data2/jianmo/data/glove/glove.840B.300d.txt', help='embedding file')
...
parser.add_argument('--reform', type='bool', default=False, help='Whether reformulate query using essential terms')
